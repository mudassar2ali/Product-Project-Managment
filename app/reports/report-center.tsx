...
const governanceReports = [
  ["governance-portfolio", "BRD / PRD Portfolio & Versions"],
  ["requirement-register", "Requirement Register"],
  ["requirement-traceability-coverage", "Traceability Coverage & Gaps"],
  ["requirement-integrity", "Unlinked, Stale & Conflicting Requirements"],
  ["signoff-approval-aging", "Approval Aging & Overdue Lanes"],
  ["signoff-condition-tracking", "Conditions & Overdue Tracking"],
  ["raci-completeness", "RACI Completeness"],
  ["feasibility-status", "Feasibility Status & Risk"],
] as const;

const releaseReports = [
  ["release-portfolio-status", "Release Portfolio Status & Readiness"],
  ["release-scope-delivery", "Release Scope vs Delivery Status"],
  ["uat-execution-pass-rate", "UAT Execution & Pass Rate"],
  ["defect-aging-severity", "Defect Aging, Severity & Status"],
